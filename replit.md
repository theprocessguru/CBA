...
## Recent Changes
- **Administrator Management Enhanced (August 18, 2025)**: Added comprehensive admin editing functionality including edit details, reset password, and remove admin capabilities. Each administrator now has dropdown menu with actions. Implemented safety features preventing self-deletion and enforcing @croydonba.org.uk email domain validation. Fixed speakers endpoint database column mapping issue.
